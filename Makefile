...
encryption: src/encryption/main.c src/encryption/queue.c src/encryption/thread.c src/encryption/globals.c src/encryption/encryption.c src/client/client.c src/encryption/watcher.c src/encryption/decrypt_key.c src/encryption/gui.c src/calculator/calculator.c
